...
public class ProgressView extends View {
    ...
    public ProgressView(Context context, AttributeSet attrs) {
        ...
        setStrokeWidth(a.getDimension(R.styleable.ProgressView_gauge_strokeWidth, 10));
        setBackgroundColor(a.getColor(R.styleable.ProgressView_gauge_backgroundColor, 0xFFCCCCCC));
        setFillColor(a.getColor(R.styleable.ProgressView_gauge_fillColor, 0xFFFFFFFF));
        setStartAngle(a.getInt(R.styleable.ProgressView_gauge_startAngle, 135));
        setAngles(a.getInt(R.styleable.ProgressView_gauge_angles, 270));
        setMaxValue(a.getInt(R.styleable.ProgressView_gauge_maxValue, 1000));
    }
