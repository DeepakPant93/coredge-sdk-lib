package com.admin.coredge.SpeedCalculation.DownloadSpeed;

import com.admin.coredge.Services.Connection;
import com.admin.coredge.Services.Utils;
import com.admin.coredge.SpeedCalculation.Logger;
...
public abstract class DownloadStream {
    ...
    private String errorHandlingMode= SpeedConfig.ONERROR_ATTEMPT_RESTART;
                ...
                try {
                    ...
                    downloader =new Downloader(c,path,ckSize) {
                        ...
                        public void onError(String err) {
                            ...
                            if(errorHandlingMode.equals(SpeedConfig.ONERROR_FAIL)){
                                DownloadStream.this.onError(err);
                                return;
                            }
                            if(errorHandlingMode.equals(SpeedConfig.ONERROR_ATTEMPT_RESTART)||errorHandlingMode.equals(SpeedConfig.ONERROR_MUST_RESTART)){
                    ...
                    if(errorHandlingMode.equals(SpeedConfig.ONERROR_MUST_RESTART)){
                        Utils.sleep(100);
                        init();
