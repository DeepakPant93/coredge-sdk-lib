...
public class ServerTestPoint {

    private final String name, server, dlURL, ulURL, pingURL, getIpURL;
    protected float ping=-1;

    public ServerTestPoint(String name, String server, String dlURL, String ulURL, String pingURL, String getIpURL){
        this.name=name;
        this.server=server;
        this.dlURL=dlURL;
        this.ulURL=ulURL;
    ...
    public ServerTestPoint(JSONObject json){
        try {
