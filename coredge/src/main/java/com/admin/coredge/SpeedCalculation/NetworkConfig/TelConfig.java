...
public class TelConfig {
    ...
    public TelConfig(String telemetryLevel, String server, String path, String shareURL){
    ...
    public TelConfig(JSONObject json){
        try{
    ...
    public TelConfig clone(){
        return new TelConfig(telemetryLevel,server,path,shareURL);
    }
}
